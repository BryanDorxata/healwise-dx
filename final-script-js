...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var indRadio2 = document.getElementsByName("individual-therapy-radio")[0];
  var grpRadio2 = document.getElementsByName("group-therapy-radio")[0];
  var famRadio2 = document.getElementsByName("family-couples-therapy-radio")[0];
  var txtRadio2 = document.getElementsByName("text-service-radio")[0];
  var supRadio2 = document.getElementsByName("support-group-radio")[0];
  var perRadio2 = document.getElementsByName("peer-support-radio")[0];
  var hotRadio2 = document.getElementsByName("hotline-radio")[0];
  var chtRadio2 = document.getElementsByName("chat-service-radio")[0];
  var guiRadio2 = document.getElementsByName("guided-self-help-radio")[0];
  ...
  selectField2.addEventListener("change", function () {
    if (selectField2.value === "Individual therapy") {
      indRadio2.checked = true;
    } else {
      indRadio2.checked = false;
    }
  });

  selectField2.addEventListener("change", function () {
    if (selectField2.value === "Group therapy") {
      grpRadio2.checked = true;
    } else {
      grpRadio2.checked = false;
    }
  });

  selectField2.addEventListener("change", function () {
    if (selectField2.value === "Family & couples therapy") {
      famRadio2.checked = true;
    } else {
      famRadio2.checked = false;
    }
  });

  selectField2.addEventListener("change", function () {
    if (selectField2.value === "Text services") {
      txtRadio2.checked = true;
    } else {
      txtRadio2.checked = false;
    }
  });

  selectField2.addEventListener("change", function () {
    if (selectField2.value === "Support group") {
      supRadio2.checked = true;
    } else {
      supRadio2.checked = false;
    }
  });

  selectField2.addEventListener("change", function () {
    if (selectField2.value === "Peer support") {
      perRadio2.checked = true;
    } else {
      perRadio2.checked = false;
    }
  });

  selectField2.addEventListener("change", function () {
    if (selectField2.value === "Hotlines") {
      hotRadio2.checked = true;
    } else {
      hotRadio2.checked = false;
    }
  });

  selectField2.addEventListener("change", function () {
    if (selectField2.value === "Chat services") {
      chtRadio2.checked = true;
    } else {
      chtRadio2.checked = false;
    }
  });

  selectField2.addEventListener("change", function () {
    if (selectField2.value === "Guided self-help") {
      guiRadio2.checked = true;
    } else {
      guiRadio2.checked = false;
    }
  });
});
